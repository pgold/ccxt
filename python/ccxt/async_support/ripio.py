...
class ripio(Exchange, ImplicitAPI):
    ...
    async def fetch_order_book(self, symbol: str, limit: Optional[int] = None, params={}):
        ...
        response = await self.publicGetOrdersLevel3(params)
        #
        #     {
        #         "message": null,
        #         "data": {
    ...
    async def fetch_l2_order_book(self, symbol: str, limit: Optional[int] = None, params={}):
        ...
        symbol = self.symbol(symbol)
        params = self.extend(params, {'pair': self.market_id(symbol)})
        response = await self.publicGetOrdersLevel2(params)
        #
        #     {
        #         "data": {
        #             "asks": [
    ...
    async def fetch_balance(self, params={}):
        ...
        """
        await self.load_markets()
        response = await self.privateGetUserBalances(params)
        #
        #     {
        #         "data": [
        #             {
    ...
    async def create_order(self, symbol: str, type: str, side: OrderSide, amount, price=None, params={}):
        """
