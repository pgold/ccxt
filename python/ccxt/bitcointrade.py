...
class bitcointrade(Exchange):
    ...
    def fetch_markets(self, params={}):
        ...
        """
        response = self.publicGetPublicPairs(params)
        #
        #     {
        #         "data":[
        #             {
    ...
    def fetch_ticker(self, symbol, params={}):
        ...
        response = self.publicGetPublicPairTicker(self.extend(request, params))
        #
        #     {
        #         "data": {
        #             "buy": 103478,
    ...
    def fetch_tickers(self, symbols=None, params={}):
        ...
        response = self.publicGetPublicTicker(params)
        #
        #     {
        #         "data": [
        #             {
    ...
    def fetch_order_book(self, symbol, limit=None, params={}):
        ...
        response = self.publicGetPublicPairOrders(self.extend(request, params))
        #
        #     {
        #         "data": {
        #             "asks": [
    ...
    def fetch_trades(self, symbol, since=None, limit=None, params={}):
        ...
        response = self.publicGetPublicPairTrades(self.extend(request, params))
        #
        #    {
        #        "data": {
        #            "pagination": {
    ...
    def fetch_open_orders(self, symbol=None, since=None, limit=None, params={}):
        ...
        if limit is not None:
            request['page_size'] = limit
        response = self.privateGetMarketUserOrdersOpen(self.extend(request, params))
        #
        #     {
        #         "data": {
        #             "orders": [
    ...
    def withdraw(self, code, amount, address, tag=None, params={}):
        ...
        if memo is not None:
            request['memo'] = memo
        response = self.privatePostCurrencyWithdraw(self.extend(request, params))
        #
        #     {
        #         "data": {
        #             "code": "B1qBrtEBN",
    ...
    def fetch_deposits(self, code=None, since=None, limit=None, params={}):
        ...
        if limit is not None:
            request['page_size'] = limit
        response = self.privateGetCurrencyDeposits(self.extend(request, params))
        #     {
        #         "data": {
        #             "deposits": [
        #                 {
    ...
    def fetch_withdrawals(self, code=None, since=None, limit=None, params={}):
        ...
        if limit is not None:
            request['page_size'] = limit
        response = self.privateGetCurrencyWithdraw(self.extend(request, params))
        #     {
        #         "data": {
        #             "pagination": {
        #                 "current_page": 1,
    ...
    def fetch_my_trades(self, symbol=None, since=None, limit=None, params={}):
        ...
        if limit is not None:
            request['page_size'] = limit
        response = self.privateGetMarketTrades(self.extend(request, params))
        #
        #     {
        #         "data": {
        #             "pagination": {
