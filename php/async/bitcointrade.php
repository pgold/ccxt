...
class bitcointrade extends Exchange {
    ...
    public function fetch_markets($params = array ()) {
        return Async\async(function () use ($params) {
             ...
             */
            $response = Async\await($this->publicGetPublicPairs ($params));
            //
            //     {
            //         "data":array(
            //             {
    ...
    public function fetch_ticker($symbol, $params = array ()) {
        return Async\async(function () use ($symbol, $params) {
            ...
            $response = Async\await($this->publicGetPublicPairTicker (array_merge($request, $params)));
            //
            //     {
            //         "data" => array(
            //             "buy" => 103478,
    ...
    public function fetch_tickers($symbols = null, $params = array ()) {
        return Async\async(function () use ($symbols, $params) {
            ...
            $response = Async\await($this->publicGetPublicTicker ($params));
            //
            //     {
            //         "data" => array(
            //             {
    ...
    public function fetch_order_book($symbol, $limit = null, $params = array ()) {
        return Async\async(function () use ($symbol, $limit, $params) {
            ...
            $response = Async\await($this->publicGetPublicPairOrders (array_merge($request, $params)));
            //
            //     {
            //         "data" => array(
            //             "asks" => array(
    ...
    public function fetch_trades($symbol, $since = null, $limit = null, $params = array ()) {
        return Async\async(function () use ($symbol, $since, $limit, $params) {
            ...
            $response = Async\await($this->publicGetPublicPairTrades (array_merge($request, $params)));
            //
            //    {
            //        "data" => {
            //            "pagination" => array(
    ...
    public function fetch_balance($params = array ()) {
        return Async\async(function () use ($params) {
             ...
             */
            Async\await($this->load_markets());
            $response = Async\await($this->privateGetWalletsBalance ($params));
            //
            //     {
            //         "data" => array(
            //             array(
    ...
    public function create_order($symbol, $type, $side, $amount, $price = null, $params = array ()) {
        return Async\async(function () use ($symbol, $type, $side, $amount, $price, $params) {
            ...
            $response = Async\await($this->privatePostMarketCreateOrder (array_merge($request, $params)));
            //
            //     {
            //         "data" => array(
            //             "code" => "F2ZJW7wqi",
    ...
    public function cancel_order($id, $symbol = null, $params = array ()) {
        return Async\async(function () use ($id, $symbol, $params) {
            ...
            $response = Async\await($this->privateDeleteMarketUserOrders (array_merge($request, $params)));
            //
            //     {
            //         "data" => array(
            //             "code" => "F2ZJW7wqi",
    ...
    public function fetch_order($id, $symbol = null, $params = array ()) {
        return Async\async(function () use ($id, $symbol, $params) {
            ...
            $response = Async\await($this->privateGetMarketUserOrdersCode (array_merge($request, $params)));
            //
            //     {
            //         "data" => {
            //             "code" => "SkvtQoOZf",
    ...
    public function fetch_orders($symbol = null, $since = null, $limit = null, $params = array ()) {
        return Async\async(function () use ($symbol, $since, $limit, $params) {
            ...
            $response = Async\await($this->privateGetMarketUserOrdersList (array_merge($request, $params)));
            //
            //     {
            //         "data" => {
            //             "orders" => array(
    ...
    public function fetch_open_orders($symbol = null, $since = null, $limit = null, $params = array ()) {
        return Async\async(function () use ($symbol, $since, $limit, $params) {
            ...
            $response = Async\await($this->privateGetMarketUserOrdersOpen (array_merge($request, $params)));
            //
            //     {
            //         "data" => {
            //             "orders" => array(
    ...
    public function withdraw($code, $amount, $address, $tag = null, $params = array ()) {
        return Async\async(function () use ($code, $amount, $address, $tag, $params) {
            ...
            $response = Async\await($this->privatePostCurrencyWithdraw (array_merge($request, $params)));
            //
            //     {
            //         "data" => array(
            //             "code" => "B1qBrtEBN",
    ...
    public function fetch_deposits($code = null, $since = null, $limit = null, $params = array ()) {
        return Async\async(function () use ($code, $since, $limit, $params) {
            ...
            $response = Async\await($this->privateGetCurrencyDeposits (array_merge($request, $params)));
            //     {
            //         "data" => {
            //             "deposits" => array(
            //                 {
    ...
    public function fetch_withdrawals($code = null, $since = null, $limit = null, $params = array ()) {
        return Async\async(function () use ($code, $since, $limit, $params) {
            ...
            $response = Async\await($this->privateGetCurrencyWithdraw (array_merge($request, $params)));
            //     {
            //         "data" => {
            //             "pagination" => array(
            //                 "current_page" => 1,
    ...
    public function fetch_my_trades($symbol = null, $since = null, $limit = null, $params = array ()) {
        return Async\async(function () use ($symbol, $since, $limit, $params) {
            ...
            $response = Async\await($this->privateGetMarketTrades (array_merge($request, $params)));
            //
            //     {
            //         "data" => {
            //             "pagination" => array(
