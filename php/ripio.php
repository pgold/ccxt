...
use ccxt\abstract\ripio as Exchange;
...
class ripio extends Exchange {
    ...
    public function fetch_order_book(string $symbol, ?int $limit = null, $params = array ()) {
        ...
        $response = $this->publicGetOrdersLevel3 ($params);
        //
        //     {
        //         "message" => null,
        //         "data" => {
    ...
    public function fetch_l2_order_book(string $symbol, ?int $limit = null, $params = array ()) {
        ...
        $symbol = $this->symbol($symbol);
        $params = array_merge($params, array( 'pair' => $this->market_id($symbol) ));
        $response = $this->publicGetOrdersLevel2 ($params);
        //
        //     {
        //         "data" => array(
        //             "asks" => array(
    ...
    public function fetch_web_socket_ticket() {
         ...
         */
        $this->load_markets();
        $response = $this->privatePostTicket ();
        //
        //     {
        //         "message" => null,
        //         "data" => {
